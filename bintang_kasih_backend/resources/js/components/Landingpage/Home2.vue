    ...
    <div>
        ...
        >
            ...
            <div class="content">
                ...
                <button @click="showSejarahAlert" class="btn btn-primary mt-3">
                    Sejarah Lengkap
                </button>
            </div>
        </section>
                    ...
                    >
                        <div class="card purple-shadow border-0">
                            <div class="row g-0">
                                ...
                                >
                                    <img
                                        src="../../../../public/frontend/images/PPDB.jpg"
                                        oncontextmenu="return false;"
                                        alt="Gambar Pendaftaran Siswa Baru"
                                        class="img-fluid"
                                        style="
                                            object-fit: cover;
                                            height: 100%;
                                ...
                                >
                                    <div class="card-body text-center mx-auto">
                                        <i
                                            class="fas fa-book-open fa-4x mb-3"
                                            style="color: #7f86d4"
                                        ></i>
                                        <h3 class="card-title">
                                            Pendaftaran Siswa KB & TK Bintang
                                            Kasih
                                        </h3>
                                        <p class="card-text">
...
export default {
    ...
    methods: {
        ...
        // Menangani perubahan slide Swiper
        handleSlideChange(swiper) {
            console.log('Slide berubah ke index:', swiper.activeIndex);
        },
    },
};
</script>
